# https://torchvision.mlverse.org/articles/examples/style-transfer.html
...
# Original vignette assumes we're in the torchvision package directory
# manually fixing paths...
# https://raw.githubusercontent.com/mlverse/torchvision/main/vignettes/examples/assets/picasso.jpg
# https://raw.githubusercontent.com/mlverse/torchvision/main/vignettes/examples/assets/dancing.jpg

style_img <- load_image("data/images/picasso.jpg")
content_img <- load_image("data/images/dancing.jpg")
